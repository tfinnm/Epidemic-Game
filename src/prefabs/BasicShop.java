...
public class BasicShop {
	...
	public BasicShop(int x, int y, String n) {
		...
		new Comerce(x+15,y+10,false);
		new Decoration(x,y+29,10,Design.shelf);
		new Comerce(x+6,y+35,false);
		...
		new Comerce(x+34,y+15,false);
		new Comerce(x+34,y+35,false);
		...
		new Comerce(x+46,y+15,false);
		new Comerce(x+46,y+35,false);
		...
		new Comerce(x+58,y+15,false);
		new Comerce(x+58,y+35,false);
		...
		new Comerce(x+70,y+15,false);
		new Comerce(x+70,y+35,false);
		...
		new Comerce(x+82,y+15,false);
		new Comerce(x+82,y+35,false);
		...
		new Comerce(x+94,y+15,false);
		new Comerce(x+94,y+35,false);
